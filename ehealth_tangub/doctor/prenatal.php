                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr class="no-data-row">
                                <td colspan="4" style="text-align:center; color:#666; padding:10px;">No prenatal patients found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
function filterTable() {
    ...
    // Handle "No Data Found" row dynamically
    let noDataRow = table.tBodies[0].querySelector('.no-data-row');
    if (!noDataRow) {
        noDataRow = document.createElement('tr');
        noDataRow.classList.add('no-data-row');
        noDataRow.innerHTML = '<td colspan="4" style="text-align:center; color:#666; padding:10px;">No data found.</td>';
