...
/* ================================
   GET USER AND PATIENT ID
================================ */
$user_id = $_SESSION['user_id'];

$patient_result = mysqli_query($conn, "SELECT patient_id FROM patients WHERE user_id = $user_id");
...
$consultation = mysqli_fetch_assoc($consultation_result);
...
================================ */
$information_result = mysqli_query(
    $conn,
    "SELECT *
     FROM informations
...
$information = mysqli_fetch_assoc($information_result);
...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 10px 18px; background: #007bff; color: #fff; border-radius: 6px; text-decoration: none; }
...
<div class="layout">
    ...
    <main class="main">
        ...
        <a href="consultations.php" class="btn">Back to History</a>
